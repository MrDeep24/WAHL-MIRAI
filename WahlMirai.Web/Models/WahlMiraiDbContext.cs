...
public partial class WahlMiraiDbContext : DbContext
{
    ...
    /// <summary>
    /// Census whitelist loaded by the Administrator (M02-00).
    /// Self-registration (M01-00) reads and claims entries from this set.
    /// </summary>
    ...
    public virtual DbSet<VwPendingCandidacy> VwPendingCandidacies { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // ── CensusWhitelist — maps census_whitelist (M01-00 reads/claims; M02-00 owns writes) ──
        modelBuilder.Entity<CensusWhitelist>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity.ToTable("census_whitelist", tb => tb.HasComment(
                "Lista blanca del censo: autoriza el auto-registro; no constituye cuenta de acceso (RN-1)"));
            ...
            entity.Property(e => e.DocumentHash)
                .HasMaxLength(64)
                .IsFixedLength()
                .HasComment("SHA-256 determinístico del documento, para búsqueda en el auto-registro")
                .HasColumnName("document_hash");
            entity.Property(e => e.EncryptedDocument)
                .HasMaxLength(500)
                .HasComment("Documento cifrado AES-256, mostrado en paneles administrativos")
            ...
            entity.Property(e => e.ExcluirDePromocion)
                .HasComment("1 = repitente, se omite en la promoción masiva mientras no se auto-registre")
                .HasColumnName("excluir_de_promocion");
            entity.Property(e => e.ClaimedAt)
                .HasComment("NULL = aún no reclamado; se completa al auto-registrarse (RN-1.1)")
                .HasColumnType("datetime")
                .HasColumnName("claimed_at");
            entity.Property(e => e.ClaimedByUserId)
                .HasComment("FK a users.id una vez reclamado")
                .HasColumnType("int(10) unsigned")
                .HasColumnName("claimed_by_user_id");
            entity.Property(e => e.UploadedByUserId)
                .HasComment("Administrador que cargó esta entrada")
                .HasColumnType("int(10) unsigned")
        ...
        modelBuilder.Entity<ElectionPosition>(entity =>
        {
            ...
            entity.Property(e => e.Name)
                .HasMaxLength(100)
                .HasComment("Ej: Personero, Contralor, Representante de Curso")
                .HasColumnName("name");
            entity.Property(e => e.Status)
                .HasDefaultValueSql("'ACTIVO'")
        ...
        modelBuilder.Entity<PositionRequirement>(entity =>
        {
            ...
            entity.HasIndex(e => e.PositionId, "idx_pr_position_id");
            ...
            entity.Property(e => e.Description)
                .HasMaxLength(255)
                .HasComment("Ej: Certificado de haber cursado y aprobado 10°")
                .HasColumnName("description");
            entity.Property(e => e.DisplayOrder)
                .HasDefaultValueSql("'1'")
                .HasComment("Orden para calcular el requisito")
                .HasColumnType("tinyint(3) unsigned")
                .HasColumnName("display_order");
        ...
        modelBuilder.Entity<CandidacyDocument>(entity =>
        {
            ...
            entity.ToTable("candidacy_documents", tb => tb.HasComment("Documentos de soporte cargados por el candidato para cumplir los requisitos de su cargo (RF-M04-01)"));

            entity.HasIndex(e => e.RequirementId, "idx_cd_requirement_id");
            ...
            entity.Property(e => e.RequirementId)
                .HasComment("FK al requisito del cargo que este documento intenta cumplir")
                .HasColumnType("int(10) unsigned")
        ...
        modelBuilder.Entity<VwPendingCandidacy>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_pending_candidacies");
            ...
            entity.Property(e => e.EventTitle)
                .HasMaxLength(200)
                .HasColumnName("event_title");
            entity.Property(e => e.MandatoryDocumentsUploaded)
                .HasColumnType("bigint(21)")
                .HasColumnName("mandatory_documents_uploaded");
            entity.Property(e => e.MandatoryRequirements)
                .HasColumnType("bigint(21)")
                .HasColumnName("mandatory_requirements");
            entity.Property(e => e.PositionId)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("position_id");
