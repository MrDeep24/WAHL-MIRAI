...
CREATE TABLE `candidates` (
    ...
    `status`                    ENUM('PENDIENTE','APROBADO','RECHAZADO','RETIRADO') NOT NULL DEFAULT 'PENDIENTE',
    ...
    `allow_correction`          TINYINT(1)      NOT NULL DEFAULT 0 COMMENT 'Si es 1, el elector puede subsanar su candidatura rechazada',
