...
*   **RF-M08-01 (Creación de PQR):** El elector autenticado radica una PQR (asunto + mensaje en texto libre) desde `pqr.js`. Se inserta un registro en `pqr_tickets` con `status = 'ABIERTO'`.
