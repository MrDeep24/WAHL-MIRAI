...
## Sistema de Votaciones Digitales (Wahl Mirai) — Versión 2.5
...
El modelo de base de datos de **Wahl Mirai v2.5** contempla 12 tablas organizadas relacionalmente, garantizando el anonimato del voto (RN-3), el censo persistente (RN-6), la auditoría (RN-8), el envío progresivo de correos (RN-9) y el soft-delete de procesos (RN-7.1):
