...
--  Versión: 2.6 — Corrección de restricción de unicidad en correo de contacto,
--           alineado con ERS v2.6 / RN-2.1
--
...
-- FIN DEL SCRIPT — wahl_mirai_db v2.5 (schema + semillas, todo en uno)
-- ============================================================
